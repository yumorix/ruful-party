  ...
  return (
    <div className="card max-w-6xl mx-auto">
      <div className="card-content">
        <h2 className="text-2xl font-semibold mb-4">QRコード生成</h2>
        ...
        <div className="space-y-6">
          ...
          {error && <div className="bg-error-light text-error-dark p-4 rounded-lg">{error}</div>}
                      ...
                      <div className="card-content">
                        ...
                        {participant.access_token ? (
                          ...
                          <div className="mt-4 text-center p-6 bg-gray-100 rounded-lg">
                            <p className="text-text-secondary">QRコードが生成されていません</p>
                          </div>
                        )}
                      </div>
