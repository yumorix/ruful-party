    ...
    <div>
      <nav className="mb-6" aria-label="breadcrumb">
        <ol className="flex items-center space-x-2">
          ...
          <li className="text-text-primary before:content-['/'] before:mx-2">{participant.name}</li>
        </ol>
      </nav>

      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">参加者詳細</h1>

        <div className="flex gap-2">
          <Link
            href={`/parties/${partyId}/participants/${participantId}/edit`}
