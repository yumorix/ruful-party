      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="font-medium">
                {party.current_mode === 'interim' && <span className="text-info-main">中間投票</span>}
                {party.current_mode === 'final' && <span className="text-primary-main">最終投票</span>}
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="font-medium text-2xl">{participants.length} / {party.capacity}</p>
              <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                <div 
                  className="bg-primary-main h-2.5 rounded-full" 
                  style={{ width: `${Math.min(100, (participants.length / party.capacity) * 100)}%` }}
                ></div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary-main mr-3" viewBox="0 0 20 20" fill="currentColor">
